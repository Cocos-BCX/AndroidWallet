            ...
            public void onPropertyChanged(Observable sender, int propertyId) {
                ...
                passwordVerifyDialog.setPasswordListener(new BaseVerifyPasswordDialog.IPasswordListener() {
                    ...
                    public void onFinish(String password) {
                        CocosBcxApiWrapper.getBcxInstance().decrypt_memo_message(AccountHelperUtils.getCurrentAccountName(), password, GsonSingleInstance.getGsonInstance().toJson(dealDetailModel.memo), new IBcxCallBack() {
                            @Override
