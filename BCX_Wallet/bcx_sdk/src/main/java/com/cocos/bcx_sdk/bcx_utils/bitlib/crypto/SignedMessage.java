...
public class SignedMessage implements Serializable {
    ...
    public static PublicKey recoverFromSignature(sha256_object message, String signatureBase64) throws WrongSignatureException {
...
//   }
     ...
     */
    private static RecoveryInfo recoverFromSignature(sha256_object message, byte[] signatureEncoded, Signature sig)
            throws WrongSignatureException {
...
//        byte[] messageBytes = Signatures.formatMessageForSigning(message.toString());
        // Note that the C++ code doesn't actually seem to specify any character
        // encoding. Presumably it's whatever
        // JSON-SPIRIT hands back. Assume UTF-8 for now.
        Sha256Hash messageHash = new Sha256Hash(message.hash);
