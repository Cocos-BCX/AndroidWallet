...
import com.cocos.bcx_sdk.bcx_wallet.fc.crypto.sha224_object;
    ...
    public static class memo_message {
        ...
        public ByteBuffer serialize() {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.GINGERBREAD) {
                bytesContent = text.getBytes(Charset.forName("UTF-8"));
            }
        ...
        public static memo_message deserialize(ByteBuffer byteBuffer) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.GINGERBREAD) {
                strBuffer = new String(byteSerial, 4, byteSerial.length - 4, Charset.forName("UTF-8"));
            }
