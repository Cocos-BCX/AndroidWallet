...
import com.cocos.library_base.utils.constant.RegexConstants;
...
/**
 * Created by guoningkang on 2017/6/19.
 * 正则相关工具类
 */
public final class RegexUtils {
     ...
     * 验证账户名称
     */
    public static boolean isAccountName(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_BCX_ACCOUNT_NAME, input);
    }

    /**
     * 验证账户密码
     */
    public static boolean isLegalPassword(final CharSequence input) {
